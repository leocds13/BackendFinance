...
const DespesaServices = __importStar(require("./despesa.service"));
const sequelize_1 = require("sequelize");
const moment_1 = __importDefault(require("moment"));
class DespesaController {
    createDespesa(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const Despesa = yield DespesaServices.create(req.body);
    ...
    getByQuery(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const Despesa = yield DespesaServices.getAll({
    ...
    getById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const Despesa = yield DespesaServices.getById(req.params.id);
                res.status(200).json(Despesa);
            }
            catch (e) {
                next(e);
                ...
                const Despesa = yield DespesaServices.getAll({
                    ...
                    data: {
                        [sequelize_1.Op.between]: [
                            ...
                            (0, moment_1.default)({ day: 1, month: req.params.mes - 1, year: req.params.ano }).endOf(`M`).toDate(),
                        ]
                    }
                });
                res.status(200).json(Despesa);
    ...
    updateById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const Despesa = yield DespesaServices.update(req.params.id, req.body);
                res.status(200).json(Despesa);
            }
            catch (e) {
                next(e);
    ...
    deleteById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const Despesa = yield DespesaServices.deleteById(req.params.id);
                res.status(200).json(Despesa);
            }
            catch (e) {
                next(e);
...
exports.default = new DespesaController();
